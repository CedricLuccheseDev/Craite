...
<template>
  <div class="flex flex-col h-full">
      ...
      <template v-if="!scanStarted">
        <div class="flex flex-col items-center gap-6">
          ...
          <div class="relative">
            ...
            <div class="relative flex items-center justify-center size-20 rounded-3xl bg-linear-to-b from-orange-500 to-orange-600 shadow-lg shadow-orange-500/20">
              <UIcon name="i-lucide-audio-waveform" class="text-[36px] text-white" />
            </div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <h1 class="font-display text-[48px] font-bold tracking-[-3px] bg-linear-to-b from-white to-white/40 bg-clip-text text-transparent">
              CrAIte
            </h1>
    ...
    <div class="shrink-0 flex flex-col items-center gap-3 py-5">
      ...
      <template v-else-if="scanDone && totalSamples === 0">
        <UButton color="primary" variant="solid" size="lg" icon="i-lucide-folder-plus" class="px-8" @click="emit('addFolder')">
